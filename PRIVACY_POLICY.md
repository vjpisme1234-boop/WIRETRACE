...
**Photos and files you provide.** When you take a photo with the in-app camera, or upload an image, PDF, or SVG file, that content is used to analyze the wire schematic you've selected. We do not access your camera roll or files except for the specific item you choose to photograph or upload.
...
All schematic data, analysis results, and settings are stored locally on your device. Uninstalling the app, or deleting a schematic within the app, permanently removes that data from your device. We do not maintain backend servers that retain copies of your schematics, images, or analysis results.

## Permissions We Request

- **Camera** — to photograph wire schematics for analysis.
- **Photo library / files** — to select an existing image, PDF, or SVG to analyze.
- **Microphone and speech recognition** — to support hands-free voice commands during guided reading.

Each permission is requested only when you use the corresponding feature, and you can decline or later revoke any permission in your device's system settings; declining a permission only disables the feature it supports.

## Children's Privacy

WireTrace AI is intended for professional and educational use by electricians and technicians and is not directed at children under 13. We do not knowingly collect information from children.

## Analytics and Advertising

WireTrace AI does not include third-party analytics, advertising, or tracking SDKs.
...
If you have questions about this Privacy Policy, contact us at: vjpisme1234@gmail.com
